package com.e.onlineclothingshoppingapp.adapter;
...
import com.e.onlineclothingshoppingapp.DetailsActivity;
...
public class ItemsAdapter extends RecyclerView.Adapter<ItemsAdapter.ItemsViewHolder> {
    ...
    public ItemsViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_items2,viewGroup,false);
